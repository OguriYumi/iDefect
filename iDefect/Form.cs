        ...
        private void btnRun_Click(object sender, EventArgs e)
        {
            ...
            using (SaveFileDialog sfd = new SaveFileDialog())
            {
                ...
                try
                {
                    ...
                    // 明細行（6行目以降）をチェック
                    int lineCount = rowCnt; // 初期値5（インデックス：5）
                    ...
                    string content = "加工途中のファイルを保存します。\n\n" +
                                     ...
                                     "２．　Xシフト加工1　：2出荷ファイル名＋_shift1.csv\n" +
                                     "３．　Xシフト加工2　：3出荷ファイル名＋_shift2.csv\n" +
                                     "４．　単純マージ　　：4出荷ファイル名＋_merge.csv\n" +
                                     "５．　Y座標ソート　 ：5出荷ファイル名＋_sort.csv\n" +
                                     "６．　除去加工　　　：6出荷ファイル名＋_exclusion.csv\n" +
                                     "７．　重複処理　　　：7出荷ファイル名＋_overlap.csv\n" +
                                     "８．　抽出加工      ：8出荷ファイル名＋_extraction\n" +
                                     "９．　昇降順指定　　：9出荷ファイル名＋_ysort.csv\n" +
                                     "１０．Y座標変換　　 ：10出荷ファイル名＋_coordinate.csv\n" +
                                     "１１．出荷前　　　　：11出荷ファイル名＋_previous.csv";
                    try
                    {
